                    ...
                    const fetchPromises = await tasksCopy?.map(async (item: any) => {
                        ...
                        if (!memberOnLeave) {
                            ...
                            text =
                                ...
                                + '<td height="10" align="left" valign="middle" style="border-left: 0px; border-top: 0px; padding: 5px 0px; padding-left:5px; border-right:0px">' + estimatedDescription + '</td>'
                            body1.push(text);
                        }
                    })
                    body =
                        ...
                        + '<th width="40" height="12" align="center" valign="middle" bgcolor="#eeeeee" style="padding:10px 5px;border-top: 0px;border-left: 0px;">% Comp.</th>'
                        ...
                        + '<th width="70" height="12" align="center" valign="middle" bgcolor="#eeeeee" style="padding:10px 5px;border-top: 0px;border-left: 0px;" >Est.(IN HRS)</th>'
                        + '<th width="140" height="12" align="center" valign="middle" bgcolor="#eeeeee" style="padding:10px 5px;border-top: 0px;border-left: 0px; border-right:0px" >Est. Desc.</th>'
                        + '</tr>'
                        + '</thead>'
                        + '<tbody>'
                        + body1
