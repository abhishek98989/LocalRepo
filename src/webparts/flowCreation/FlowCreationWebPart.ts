...
import * as strings from 'FlowCreationWebPartStrings';
import FlowCreation from './components/FlowCreation';
import { IFlowCreationProps } from './components/IFlowCreationProps';
...
export default class FlowCreationWebPart extends BaseClientSideWebPart<IFlowCreationWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IFlowCreationProps> = React.createElement(
      FlowCreation,
      {
