        ...
        $.each(searchTerms, function (index: any, val: any) {
            if(isSearchTermAvailable &&(item[Title]!=undefined  && Title == "ItemRank" && item[Title] == parseInt(val))){
                   ...
                   getHighlightdata(item, val);
                    ...
                    item.ClientCategory.map((item:any)=>{
                        if(item.Title == val.toLowerCase()){
                            isSearchTermAvailable = true;
                    ...
                    item.TeamLeaderUser.map((item:any)=>{
                        if(item.Title == val.toLowerCase()){
                            isSearchTermAvailable = true;
                            getHighlightdata(item, val.toLowerCase());
                        }
           ...
           else if (isSearchTermAvailable && (item[Title] != undefined && Title != "ItemRank" && Title != "ClientCategory" && item[Title].toLowerCase().indexOf(val.toLowerCase()) > -1)) {
                isSearchTermAvailable = true;
                getHighlightdata(item, val.toLowerCase());
