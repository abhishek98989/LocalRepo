...
import * as strings from 'MeetingOverviewWebPartStrings';
import MeetingOverview from './components/MeetingOverview';
import { IMeetingOverviewProps } from './components/IMeetingOverviewProps';

export interface IMeetingOverviewWebPartProps {
  description: string;
...
export default class MeetingOverviewWebPart extends BaseClientSideWebPart<IMeetingOverviewWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IMeetingOverviewProps> = React.createElement(
      MeetingOverview,
      {
