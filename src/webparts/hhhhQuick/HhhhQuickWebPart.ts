...
import * as strings from 'HhhhQuickWebPartStrings';
import HhhhQuick from './components/HhhhQuick';
import { IHhhhQuickProps } from './components/IHhhhQuickProps';

export interface IHhhhQuickWebPartProps {
  description: string;
...
export default class HhhhQuickWebPart extends BaseClientSideWebPart<IHhhhQuickWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IHhhhQuickProps> = React.createElement(
      HhhhQuick,
      {
