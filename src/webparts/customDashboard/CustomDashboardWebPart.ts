...
import * as strings from 'CustomDashboardWebPartStrings';
import CustomDashboard from './components/CustomDashboard';
import { ICustomDashboardProps } from './components/ICustomDashboardProps';

export interface ICustomDashboardWebPartProps {
  description: string;
...
export default class CustomDashboardWebPart extends BaseClientSideWebPart<ICustomDashboardWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ICustomDashboardProps> = React.createElement(
      CustomDashboard,
      {
