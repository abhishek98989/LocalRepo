            ...
            cell: ({ row, getValue }) => (
              <>
                ...
                {row?.original?.siteType == "Master Tasks" && row?.original?.Item_x0020_Type == 'Task' && (
                    ...
                    <span className="svg__iconbox svg__icon--Restructure" onClick={(e) => EditData(e,row?.original)}> </span>)} 
                    {row?.original?.Item_x0020_Type == "Task" && row?.original?.siteType != "Master Tasks" && (
    ...
    return (
        ...
        <div className={IsUpdated === 'Events' ? 'app component eventpannelorange' : (IsUpdated == 'Service' ? 'app component serviepannelgreena' : 'app component')}>
            <div className="Alltable mt-10">
                <div className="tbl-headings">
                    ...
                    <span className="toolbox mx-auto">
                        ...
                        <button type="button"
                            className="btn btn-primary" disabled={checkedList.length == 0?true:false}
            ...
            {ResturuningOpen &&
             ...
             {IsTask && <EditTaskPopup Items={SharewebTask} Call={Call} AllListId={props.AllListId} context={props.Context}></EditTaskPopup>}
